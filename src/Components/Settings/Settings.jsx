...
const Settings = ({ setIsSettingOpen, onOutsideClick }) => {
  ...
  const fetchRoles = async () => {
    try {
      const resp = await axios.get(
        " https://blu-sunday-product-be-newchangesdevbe-production.up.railway.app/api/role-config/all",
        {
          headers: {
      ...
      if (resp.data.configurations && resp.data.configurations.length > 0) {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        " https://blu-sunday-product-be-newchangesdevbe-production.up.railway.app/api/auth/update-profile",
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleRoleUpdate = async (e) => {
    ...
    try {
      const response = await fetch(
        " https://blu-sunday-product-be-newchangesdevbe-production.up.railway.app/api/role-config/configure",
        {
          method: "POST",
          headers: {
